...
<div class="left_col scroll-view">
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        <div class="menu_section" id="menu">
            ...
            ?>
                <li <?php if ($PGID_ID_GP==$GPID_srls || $PGID_ID_SGP==$GPID_srls) { echo 'class="active"'; } ?>><a><i class="<?php echo $GROUPICON; ?>"></i><?php echo $GROUPNAME; ?> <span class=""></span></a>
                    <ul class="nav child_menu" <?php if ($PGID_ID_GP==$GPID_srls || $PGID_ID_SGP==$GPID_srls) { echo 'style="display:block;"'; } ?>>
                        <?php
                    ...
                    ?>
                        <li <?php if ($page_name==$PAGEURL || $page_name==$PAGEURL_ssrls) { echo 'class="current-page"'; } ?>><a href="<?php echo $PAGEURL; ?>"><?php echo $PAGENAME; ?></a></li>
                    <?php
                    }
                    ?>
                    <!-- Main Pages End -->
