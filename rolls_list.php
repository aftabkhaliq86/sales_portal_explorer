...
<body class="nav-md">
	...
	<script type="text/javascript">
		$(document).ready(function() {
					...
					data - dismiss = "modal"
					aria - label = "Close"
					onclick = "window.location='<?php echo basename($_SERVER['PHP_SELF']) ?>'" > < span aria - hidden = "true" > & times; < /span></button >
					<
					h4 class = "modal-title"
					id = "myModalLabel" > Add Roll Details < /h4> <
						/div>
					...
					required >
						...
						div class = "col-lg-3" > < label class = "control-label" > Status < /label></div >
						<
						div class = "col-lg-9" > < label > < input type = "checkbox"
					name = "STATUS"
					value = "1"
					checked = "checked" / > Active < /label></div >
						<
						/div> <
						/div> <
						/div> <
					...
					<?php include('inc_header.php'); ?>
						...
						div class = "breadcrumb_content" >
						<
						div class = "breadcrumb_text" > < a href = "dashboard.php" > Dashboard < /a> /
					<?php echo $plu_del_rep; ?>
						<
						/div> <
						/div> <
						!--/breadcrumb -->
					...
					role = "main" >
						...
						<
						li > < a href = "<?php echo basename($_SERVER['REQUEST_URI']) ?>"
					class = "btn btn-default btn-xs"
					data - toggle = "tooltip"
					data - placement = "top"
					title = "Page Refresh" > < i class = "fa fa-refresh" > < /i></a > < /li> <
				...
				?>
						...
						<
						a href = "<?php echo basename($_SERVER['PHP_SELF']) . "?id=" . $ID . "&actc=app" ?>"
					class = "btn btn-danger btn-xs" > Inactive < /a>
				<?php
						} elseif ($STATUS == 1) {
				?>
						<
						a href = "<?php echo basename($_SERVER['PHP_SELF']) . "?id=" . $ID . "&actc=unapp" ?>"
				...
				<
				a href = "rolls_edit.php?id=<?php echo $ID; ?>"
				data - toggle = "tooltip"
				data - placement = "top"
				title = "Edit"
				...
				<
				a href = "<?php echo basename($_SERVER['PHP_SELF']) . "?del=" . $ID ?>"
